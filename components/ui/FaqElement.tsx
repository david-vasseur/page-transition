...
function FaqElement({ icon, label }: IFaqElement) {
    ...
    return (
        <div  className="absolute flex justify-center items-center sticky-card z-5 h-24 w-full">
            <div className={`w-[90%] lg:max-w-xl flex gap-8 items-center justify-evenly p-8 rounded-2xl ${Icon ? "border border-gray-500/60 bg-linear-to-br from-orange-950/60 to-red-800/60" : ""}`}>
                {Icon && 
